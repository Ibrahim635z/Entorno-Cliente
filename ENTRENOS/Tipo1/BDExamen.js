...
function valida(user,pass) {
  ...
  let usuarios=arrObjUsuarios.find(usuario => 
...
function creaCard(producto) {
    ...
    rating.textContent=producto.rating["rate"]+" | "+producto.rating["count"];
...
function creaCards(arrProductos) {
...
const filtra = (objFiltro) => {
  ...
  return arrObjBDProductos.filter(producto => 
...
const devuelveGeneros= (arrProductos) => {
  let arrCategorias=[];
  arrProductos.forEach(element => {
...
let container=document.getElementById("container");
  ...
  if (container) {
    ...
    console.log(filtra({atributo:"price",valor:100}));

    console.log(devuelveGeneros(arrObjBDProductos));
    

    let carrito1=new Carrito();
    carrito1.add(arrObjBDProductos[1]);
    document.getElementById("contenedor-carrito").appendChild(carrito1.dibujarCarrito());
