...
/**
 * Funcion que valida el usuario y contraseña introducidos
 * @param {*} user 
 * @param {*} pass 
 * @returns datosUsuario en caso de encontrarlo, en caso contrario devuelve null
 */
const valida= (user,pass) => {

    let usuarioEncontrado=arrObjUsuarios.find( usuario =>
        usuario.username===user && usuario.password===pass);
...
/**
 * Funcion para crear un nodo dom que tenga todos los datos del producto
 * @param {*} objProducto 
 * @returns devuelve ese nodo Dom
 */
...
/**
 * Funcion que reccibe un array de productos y creara la pagina usando la funcion creaCard
 * @param {*} arrObjBDProductos 
 */
const creaCards= (arrObjBDProductos) => {
    let container=document.getElementById("container");
    arrObjBDProductos.forEach(element => {
...
/**
 * Funcion que filtra segun el atributo y el valor pasado
 * @param {*} objFiltro 
 */
const filtra= (objFiltro) => {
    ...
    console.log(arrObjBDProductos.filter(producto => producto[atributo] < valor));

}

/**
 * Funcion que devuelve un array con todos los generos
 * @param {*} arrObjBDProductos 
 * @returns 
 */
...
const main= () => {
    ...
    if (container) {
        ...
        console.log(devuelveGeneros(arrObjBDProductos));
